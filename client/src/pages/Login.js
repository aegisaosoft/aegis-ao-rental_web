          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">{t('login.continueWith') || 'Or continue with'}</span>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              ...
              >
                <span className="sr-only">{t('login.signInWithGoogle') || 'Sign in with Google'}</span>
                Google
              </button>
              ...
              <button
                ...
                className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50"
              >
                <span className="sr-only">{t('login.signInWithFacebook') || 'Sign in with Facebook'}</span>
                Facebook
              </button>
            </div>
          </div>
