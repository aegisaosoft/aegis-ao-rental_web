/*
 * SecurityDepositModal - Modal for paying security deposits
 * 
...
const SecurityDepositModal = ({
  ...
  const finalDeposit = bookingDeposit > 0 ? bookingDeposit : companySecurityDeposit;
            ...
            <div className="space-y-4">
              ...
              <div className="border-t border-gray-200 pt-4">
                ...
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm font-medium text-gray-900">{booking.vehicleName}</span>
                </div>
                <div className="flex justify-between items-center mb-2">
