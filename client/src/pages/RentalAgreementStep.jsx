  ...
  <div className="border border-gray-200 rounded-lg p-4 hover:border-gray-300 transition-colors">
    <label className="flex items-start gap-3 cursor-pointer">
      ...
      <div className="flex-1">
        {title && <span className="font-medium text-gray-900 block mb-1">{title}</span>}
...
const RentalAgreementStep = ({
  ...
  const allConsentsAccepted = RULE_KEYS.every(key => consents[key]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-lg">
        ...
        <div className="px-4">
          <RuleCheckbox
            id="rule-prohibitedDriver"
            checked={consents.prohibitedDriver}
          ...
          <RuleCheckbox
            id="rule-passengerCapacity"
            checked={consents.passengerCapacity}
...
export { SignaturePad, ConsentCheckbox, RuleCheckbox, RULES_TEXTS, RULES_TEXTS as CONSENT_TEXTS, getConsentTexts, RULE_KEYS };
